                    ...
                    <div
                        className={
                            this.state.isDropdownOpen
                                ? `${classes.searchDropdown} ${classes.open}`
                                : `${classes.searchDropdown}`
                        }
                    >
                        <button
                            className={`${classes.button} ${classes.dropdownToggle}`}
                        ...
                        >
                            ...
                            <img
                                ...
                                src={this.state.isDropdownOpen ? iconArrowUp : iconArrowDown}
                                alt={"dropdown"}
                            />
                        </button>
                        {/* optimize dropdown */}
                        <ul className={classes.dropdownMenu}>
                            <li className={classes.menuActive}>
                                <a href="#">Everything</a>
                            </li>
                            <li>
                                <a href="#">People</a>
