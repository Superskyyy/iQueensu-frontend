                ...
                <div className={styles.InternationalHeader}>
                    ...
                    <div className={styles.NavBar}>
                        ...
                        chosen can be for later use */}
                            ...
                            <NavLink to={"/test1"} activeClassName="chosen">
                                <Text id={"forum"} />
                            </NavLink>
                            <NavLink to={URL_PATHS.QHOUSING_PATH} activeClassName="chosen">
                                Qhousing
                            </NavLink>
                            <NavLink to={URL_PATHS.QCUMBER_PATH} activeClassName="chosen">
                                Qcumber
                            </NavLink>
                            <NavLink to={"/test3"} activeClassName="chosen" style={{ margin: "0px 59px 0px 8px" }}>
                                Qwiki
                            </NavLink>
                            <NavLink to={"/test4"} activeClassName="chosen">
                                <Text id={"contact"} />
                            </NavLink>
                            <NavLink to={"/test4"} activeClassName="chosen">
                                <Text id={"about"} />
                            </NavLink>
                            <NavLink to={"/test5"} activeClassName="chosen" style={{ margin: "0px 8px 0px 57px" }}>
                                i<span style={{ color: "#003060" }}>Queensu</span>
                            </NavLink>
                        </div>
                    </div>
