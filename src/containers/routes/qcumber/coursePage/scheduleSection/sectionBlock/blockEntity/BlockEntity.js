...
export const BlockEntity = (props) => {
    ...
    const acronym =
        props.timeBlockEntity["type"] === "lecture"
            ? " LEC"
            : props.timeBlockEntity["type"] === "lab"
            ? " LAB"
            : " TUT";
        ...
        <Fragment>
            <div className={classes.section} tabIndex={0}>
                <div className={classes.sectionTitleBar}>
                    <div className={`${classes.sectionFrontPart} ${classes.frontPartPadding}`}>
                        <div style={{ width: "88px" }}>
                            <span className={classes.sectionName}>
                                {props.timeBlockEntity["name"]} {acronym}
                            </span>
                            <br />
                    ...
                    <button
                        className={`${classes.sectionBackPart} ${classes.backPartPadding}`}
                ...
                <table className={classes.sectionTable}>
                    <tbody>
                        {props.timeBlockEntity["schedule"].map((scheduleEntity, id) => {
                            return (
                                <tr key={id} className={classes.sectionTableRow}>
                                    <td style={{ paddingLeft: "18px" }} className={classes.sectionTableCell}>
                                        {scheduleEntity["weekday"]}
                                    </td>
                                    ...
                                    <td className={classes.sectionTableCell}>
                                        <a href="https://google.com">{props.timeBlockEntity["professor"]}</a>
                                    </td>
                                    <td
                                        style={{ paddingLeft: "60px", width: "210px" }}
                                        className={classes.sectionTableCell}
                                    >
                                        {props.timeBlockEntity["duration"]}
                                    </td>
                                </tr>
                            );
                        })}
