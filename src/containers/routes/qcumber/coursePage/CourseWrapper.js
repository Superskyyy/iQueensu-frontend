                ...
                <div className={styles.coursePageCenterPart}>
                    ...
                    <div className={styles.mytable}>
                        ...
                        <div className={styles.myrow}>
                            ...
                            <div
                                className={styles.mycell}>{this.props.currentCourse.length < 1 ? null : this.props.currentCourse[0]["career"]}</div>
                            <div className={styles.mycellHeader}>Academic Group</div>
                            <div
                                className={styles.mycell}>{this.props.currentCourse.length < 1 ? null : this.props.currentCourse[0]["academic_group"]}</div>
                        </div>
                        <div className={styles.myrow}>
                            <div className={styles.mycellHeader}>Units</div>
                            <div className={styles.mycell}
                                 style={{color: "green"}}>{this.props.currentCourse.length < 1 ? null : this.props.currentCourse[0]["units"]}</div>
                            <div className={styles.mycellHeader}>Academic Organization</div>
                            <div
                                className={styles.mycell}>{this.props.currentCourse.length < 1 ? null : this.props.currentCourse[0]["academic_organization"]}</div>
                        </div>
                    ...
                    <div className={styles.mytable} style={{marginTop: "3.5rem"}}>
                        ...
                        <div className={styles.myrow}>
                            ...
                            <div
                                className={styles.mycellWholeRight}>{this.props.currentCourse.length < 1 ? null : this.props.currentCourse[0]["course_description"]}</div>
                        </div>
                    </div>
