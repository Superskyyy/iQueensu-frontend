...
class CourseWrapper extends React.Component {
            ...
            courseSchedule: [
                {
                    ...
                    schedule: [
                        { time: "8:30am - 9:30am", weekday: "Tue" },
                        { time: "10:30am - 11:30am", weekday: "Wed" },
                    ],
                    status: "valid",
    ...
    render() {
        ...
        const listRating = (mock ? mockRating : realRating)
            ...
            .map((rate) => {
                return <CommentDisplay {...rate}></CommentDisplay>;
            });
        return (
            <div className={styles.coursePageDashBoard}>
                {/* <Fragment> */}
                <div className={styles.coursePageLeftPart}>{/* this div is meant to be blank */}</div>

                <div className={styles.coursePageCenterPart}>
                    {/* <backtrace /> */}
                    <div>
                        <h3 className={styles.coursePageCourseSubjAndNum}>{`${subject} ${courseNumber}`}</h3>
                    </div>
                    ...
                    <div className={styles.mytable}>
                        ...
                        <div className={styles.myrow}>
                            ...
                            <div className={styles.mycell}>
                                {this.props.currentCourse.length < 1 ? null : this.props.currentCourse[0]["career"]}
                            </div>
                            <div className={styles.mycellHeader}>Academic Group</div>
                            <div className={styles.mycell}>
                                {this.props.currentCourse.length < 1
                                    ? null
                                    : this.props.currentCourse[0]["academic_group"]}
                            </div>
                        </div>
                        <div className={styles.myrow}>
                            <div className={styles.mycellHeader}>Units</div>
                            <div className={styles.mycell} style={{ color: "green" }}>
                            ...
                            <div className={styles.mycell}>
                                {this.props.currentCourse.length < 1
                                    ? null
                                    : this.props.currentCourse[0]["academic_organization"]}
                            </div>
                        </div>
                    </div>
                    ...
                    <div className={styles.mytable} style={{ marginTop: "3.5rem" }}>
                        ...
                        <div className={styles.myrow}>
                            ...
                            <div className={styles.mycellWholeRight}>
                                {this.props.currentCourse.length < 1
                                    ? null
                                    : this.props.currentCourse[0]["course_description"]}
                            </div>
                        </div>
                    </div>
                    ...
                    <div className={styles.mytable} style={{ marginTop: "2rem" }}>
                        ...
                        <div className={styles.myrow}>
                            <ScheduleSection schedule={this.state.courseSchedule} />
                        </div>
                    </div>
                </div>

                <div className={styles.coursePageRightPart}>
                    <div className="Subtitle1">Course Review</div>
                    {listRating}
                </div>
                {/* </Fragment> */}
            </div>
