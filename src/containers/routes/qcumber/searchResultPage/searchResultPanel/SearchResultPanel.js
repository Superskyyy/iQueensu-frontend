                ...
                return(
                    ...
                    <div className={classes.Labelstyle}>
                        <p className={classes.Label}>
                                {/* TODO: adding its constant and to right interface places */}
                                <text className={classes.fonts}>Units</text> {result["units"]}
                        </p>
                        <p className={classes.Label}>
                                {/* TODO: adding its constant and to right interface places */}
                                <text className={classes.fonts}>Career</text> {result["career"]}
                        </p>
                        <p className={classes.Label}>
                                {/* TODO: adding its constant and to right interface places */}
                                <text className={classes.fonts}>Grading</text> {result["grading"]}
                        </p>
                    </div>
            )})}
        </div>
