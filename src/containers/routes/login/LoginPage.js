...
class LoginPage extends Component {
    ...
    Login = (prop) => {
        return (
            <>
                ...
                <div className={styles.func}>
                    <NavLink to={"/signup"} className={styles.change}>
                        Register
                    </NavLink>
                    <button className={styles.but1} type="submit" data-test="submit">
                        Login
                    </button>
                </div>
            </>
    ...
    render() {
        return <this.LoginLayout type={this.layoutType}>{<this.Login />}</this.LoginLayout>;
    }
}
