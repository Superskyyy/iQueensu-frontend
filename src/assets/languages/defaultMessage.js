...
export const messages = defineMessages({
    ...
    gradeDistributionTitle: {
        id: "gradeDistributionTitle",
        defaultMessage: en_US.gradeDistributionTitle,
    },
    courseCatalogTitle: {
        id: "courseCatalogTitle",
        defaultMessage: en_US.courseCatalogTitle,
    },
    degreePlanningTitle: {
        id: "degreePlanningTitle",
        defaultMessage: en_US.degreePlanningTitle,
    },
    secretLibraryTitle: {
        id: "secretLibraryTitle",
        defaultMessage: en_US.secretLibraryTitle,
    },
